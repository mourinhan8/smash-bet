...
export function getKeyByAlias(object: any, alias: string) {
  return Object.keys(object).find(key => object[key].alias === alias);
}
...
const countriesFlags: any = {
  ...
  Netherland: { mini: "http://flags.fmcdn.net/data/flags/mini/nl.png", normal: "http://flags.fmcdn.net/data/flags/normal/nl.png" },
  NZ: {
    alias: "New Zealand",
  ...
  Vietnam: { alias:"Viet Nam", mini: "http://flags.fmcdn.net/data/flags/mini/vn.png", normal: "http://flags.fmcdn.net/data/flags/normal/vn.png" },
  Sahara: {
