...
var transport1 = new winston.transports.DailyRotateFile({
    level: "info",
    filename: path.join(__dirname, "../../logs/info/", `Smash-Bros-BE-info_%DATE%.log`),
...
var transport2 = new winston.transports.DailyRotateFile({
    ...
    filename: path.join(__dirname, "../../logs/warn/", `Smash-Bros-BE-warning_%DATE%.log`),
    datePattern: "YYYY-MM-DD",
    zippedArchive: true,
    maxSize: "50m",
    maxFiles: "14d",
...
const logger = winston.createLogger({
    format: winston.format.combine(winston.format.timestamp(), winston.format.prettyPrint(), customFormat),
    transports: [
